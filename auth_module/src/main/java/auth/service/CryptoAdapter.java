...
public class CryptoAdapter 
{
    ...
    public byte[] unwrapTeamKey(byte[] envelope, PublicKey senderPublicKey, PrivateKey myPrivateKey)
    ...
    public byte[] decryptDocument(byte[] ciphertext, byte[] teamKey, byte[] nonce, byte[] aad)
            throws AEADBadTagException 
    {

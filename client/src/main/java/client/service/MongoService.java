...
public class MongoService {
    ...
    public void createTeam(client.model.Team team) {
    ...
    public List<client.model.Team> getTeamsForUser(String email) {
        List<client.model.Team> list = new ArrayList<>();
        MongoCollection<Document> teams = db.getCollection("teams");
        
        for (Document doc : teams.find(com.mongodb.client.model.Filters.in("members", email))) {
            client.model.Team t = new client.model.Team(
